    ...
    function generateMaskSet(opts, nocache) {
        function generateMask(mask, metadata, opts) {
            if (null !== mask && "" !== mask) {
                ...
                return (
                    void 0 === Inputmask.prototype.masksCache[mask] ||
                    nocache === !0
                        ? ((masksetDefinition = {
                              mask: mask,
        ...
        function isValid(pos, c, strict, fromSetValid, fromAlternate) {
            ...
            function trackbackAlternations(originalPos, newPos) {
                ...
                if (vp)
                    for (
                        ...
                        if (
                            void 0 === getMaskSet().validPositions[ps] &&
                            !isMask(ps, !0)
                        ) {
            ...
            return (
                ...
                $.isFunction(opts.postValidation) &&
                    ...
                    fromSetValid !== !0 &&
                    (result =
                        !!opts.postValidation(getBuffer(!0), result, opts) &&
                        result),
                                ...
                                if (clickPosition < lastPosition)
                                    ...
                                    ((("" !== placeholder &&
                                        ...
                                        getTest(lastPosition).match
                                            .optionalQuantifier !== !0) ||
                                        (!isMask(lastPosition) &&
                                            getTest(lastPosition).match.def ===
                                                placeholder)) &&
            ...
            Inputmask.extendAliases({
                numeric: {
                    ...
                    postFormat: function (buffer, pos, opts) {
                        ...
                        ((isNegative =
                            null !== isNegative && 1 === isNegative.length),
                            pos >
                                (isNegative
                        ...
                        ((bufVal = opts.prefix + bufVal + opts.suffix),
                            isNegative &&
                                (bufVal =
                                    ...
                                    opts.negationSymbol.back));
                        var needsRefresh =
                                bufValOrigin !== bufVal.split("").join(),
                    ...
                    onBeforeWrite: function (e, buffer, caretPos, opts) {
                        ...
                        if (
                            ...
                            var maskedValue = opts.numericInput
                                    ...
                                    : buffer.join(""),
                                processValue = maskedValue.replace(
                                    opts.prefix,
                                    "",
                                );
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    return (
                                        (processValue = (
                                            opts.prefix + processValue.join("")
                                        ).split("")),
                                        !isNegative ||
                                            (0 === floatValue &&
                                                "blur" === e.type) ||
                                            (processValue.unshift(
                                                opts.negationSymbol.front,
                                            ),
                                            processValue.push(
                                                opts.negationSymbol.back,
                    ...
                    onBeforeMask: function (initialValue, opts) {
                        ...
                        if (
                            ...
                            var valueParts = initialValue.split(
                                    opts.radixPoint,
                                ),
                                decPart = valueParts[1].match(
                                    new RegExp("\\d*"),
                                )[0];
                            if (
                                ...
                                function validateRegexToken(token, fromGroup) {
                                    ...
                                    for (
                                        ...
                                        if (matchToken.isGroup === !0)
                                            ...
                                            if (
                                                isNaN(matchToken.quantifier.max)
                                            ) {
                                                for (
                                                    ;
